...
<html lang="en">
    ...
    <head>
        ...
        <title>Register SPD Center</title>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Silakan masukkan data berikut untuk mendaftar</p>
                        		</div>
                            ...
                            {!! csrf_field() !!}
			                    	<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
			                        	...
			                        	<input type="text" name="name" placeholder="Nama" class="form-username form-control" id="form-username" value="{{ old('name') }}">
                                  @if ($errors->has('name'))
                              ...
                              @endif
			                    	...
			                    	<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
			                        	...
			                        	<input type="text" name="name" placeholder="Email" class="form-username form-control" id="form-username" value="{{ old('email') }}">
                                  @if ($errors->has('email'))
                                  <span class="help-block">
                              ...
                              @endif
                                ...
                                @endif
			                        ...
			                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
			                        	...
			                        	<input type="password" name="password_confirmation" placeholder="Konfirmasi Password" class="form-password form-control" id="form-password">
                              ...
                              <a class="btn btn-link" href="{{ url('/login') }}" style="color:white">Sudah memiliki akun?</a>
