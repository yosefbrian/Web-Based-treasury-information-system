...
<table style="width:100%">
    ...
    <tr>
        ...
        <td><a class="btn btn-danger" data-placement="bottom" title="Hapus Data" data-toggle="modal" href="#" data-target="#modaldelete<?php echo $tukin->id;?>"><span class="glyphicon glyphicon-trash"></a></td>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger btn-simple" title="Hapus" href="{{ action('PeraturanController@deletetukin', $tukin->id) }}">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
