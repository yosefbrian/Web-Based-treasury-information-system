...
<div class="alert alert-danger"><strong>Sukses!</strong> Anda berhasil menghapus Peraturan Tunjangan Kinerja.<em> {!! session('flash_message') !!}</em></div>
@endif
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-danger btn-simple pull-right" style="width:60px" title="Hapus" href="{{ action('PeraturanController@deletetukin', $tukin->id) }}">Ya</a>
                    </div>
