...
<br>
<div class="" style="text-align:center">
  <a  href="{{ url('admin/statistik/angkutantahun')}}" type="button" class="btn btn-warning btn-simple " style="margin-top:-5px"><i class=""></i>Tahunan</a>
  <a  href="{{ url('admin/statistik/angkutanbulan')}}" type="button" class="btn btn-warning btn-simple disabled" style="margin-top:-5px"><i class=""></i>Bulanan</a>
</div>
