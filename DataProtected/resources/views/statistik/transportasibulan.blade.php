...
<ol class="breadcrumb">
  ...
  <li><a href="#">Pengeluaran Transportasi</a></li>
</ol>
...
<a  href="{{ url('admin/statistik/transportasitahun')}}" type="button" class="btn btn-info btn-simple disabled" style="margin-top:-5px"><i class=""></i>Pengeluaran Transportasi</a>
...
<div class="" style="text-align:center">
  <a  href="{{ url('admin/statistik/transportasitahun')}}" type="button" class="btn btn-warning btn-simple " style="margin-top:-5px"><i class=""></i>Tahunan</a>
  <a  href="{{ url('admin/statistik/transportasibulan')}}" type="button" class="btn btn-warning btn-simple disabled" style="margin-top:-5px"><i class=""></i>Bulanan</a>
</div>
