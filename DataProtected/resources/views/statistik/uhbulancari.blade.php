...
<ol class="breadcrumb">
  ...
  <li><a href="#">Pengeluaran Uang Harian</a></li>
</ol>
...
<a  href="{{ url('admin/statistik/uhtahun')}}" type="button" class="btn btn-info btn-simple disabled" style="margin-top:-5px"><i class=""></i>Pengeluaran Uang Harian</a>
...
<div class="" style="text-align:center">
  <a  href="{{ url('admin/statistik/uhtahun')}}" type="button" class="btn btn-warning btn-simple " style="margin-top:-5px"><i class=""></i>Tahunan</a>
  <a  href="{{ url('admin/statistik/uhbulan')}}" type="button" class="btn btn-warning btn-simple disabled" style="margin-top:-5px"><i class=""></i>Bulanan</a>
</div>
...
<div class="tab-content">
  <div id="bulan" class="tab-pane fade in active">
    <div class="row">
        ...
        <a href="{{ url('admin/statistik/uhbulan')}}">Pengeluaran per Bulan</a></li> -->
        <form action="{{ url('admin/statistik/uhbulancari') }}" method="post" enctype="multipart/form-data">
  ...
  <div id="tahun" class="tab-pane fade">
    <div class="row">
        ...
        <a href="{{ url('admin/statistik/uhtahun')}}">Pengeluaran per Tahun</a></li>
