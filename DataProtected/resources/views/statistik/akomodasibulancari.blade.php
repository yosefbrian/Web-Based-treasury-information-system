...
<ol class="breadcrumb">
  ...
  <li><a href="#">Pengeluaran Akomodasi</a></li>
</ol>
...
<a  href="{{ url('admin/statistik/akomodasitahun')}}" type="button" class="btn btn-info btn-simple disabled" style="margin-top:-5px"><i class=""></i>Pengeluaran Akomodasi</a>
...
<div class="" style="text-align:center">
  <a  href="{{ url('admin/statistik/akomodasitahun')}}" type="button" class="btn btn-warning btn-simple" style="margin-top:-5px"><i class=""></i>Tahunan</a>
  <a  href="{{ url('admin/statistik/akomodasibulan')}}" type="button" class="btn btn-warning btn-simple disabled" style="margin-top:-5px"><i class=""></i>Bulanan</a>
</div>

  <div id="bulan" class="tab-pane fade in active">
    <div class="row">
        <!-- <a href="{{ url('admin/statistik/akomodasibulan')}}">Pengeluaran per Bulan</a></li> -->
        <form action="{{ url('admin/statistik/akomodasibulancari') }}" method="post" enctype="multipart/form-data">
...
<!--
  <div id="tahun" class="tab-pane fade">
    <div class="row">
        ...
        <a href="{{ url('admin/statistik/akomodasitahun')}}">Pengeluaran per Tahun</a></li>
