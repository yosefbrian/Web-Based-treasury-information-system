...
@role(1)
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('/admin/bp1/ubah/'.$bp1->id) }}" method="post" enctype="multipart/form-data" style="margin-top:20px">
@endrole

@role(2)
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{url('/bp/bp1/ubah/'.$bp1->id) }}" method="post" enctype="multipart/form-data" style="margin-top:20px">
@endrole
  ...
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" name="keterangan" value="{{ $bp1->keterangan }}" class="form-control col-md-7 col-xs-12">
    </div>
  </div>
